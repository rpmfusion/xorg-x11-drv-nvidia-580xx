%global        _nvidia_serie        nvidia-580xx
...
Source1:         https://us.download.nvidia.com/XFree86/Linux-aarch64/%{version}/NVIDIA-Linux-aarch64-%{version}.run
...
%else
Requires:       xserver-abi(videodrv-24)
%endif
...
- Update xorg-x11-drv-nvidia-580xx to 580.142

* Fri Feb 20 2026 Sérgio Basto <sergio@serjux.com> - 3:580.126.18-1
- Update xorg-x11-drv-nvidia-580xx to 580.126.18

* Mon Feb 16 2026 Nicolas Chauvet <kwizart@gmail.com> - 3:580.126.09-2.1
- Rebuilt
...
* Wed Jul 23 2025 Leigh Scott <leigh123linux@gmail.com> - 3:575.64.05-1
